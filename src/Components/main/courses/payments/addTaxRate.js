                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-flex align-items-center justify-content-between">
                                <h4 className="mb-0">Add New Tax Rate
                                </h4>

                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><Link to="/dashboard">TellyTell</Link></li>
                                        <li className="breadcrumb-item">Payment Settings - Add New Tax Rate</li>
                                    </ol>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control input-field" />
                                                            <label for="basicpill-phoneno-input" class="label-100">
                                                                This tax rate will be applicable to the products you
                                                                select.
                                                            </label>
                                                        </div>
                                                    </div>
